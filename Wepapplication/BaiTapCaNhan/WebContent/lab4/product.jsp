...
initial-scale=1">
<link rel="stylesheet" href="<%=application.getContextPath() %>/Boot/css/bootstrap.min.css">
<script
		...
		<div class="row">
			...
			<div class="col-sm-6 col-md-3">
				<div style="border: 1px solid gray;" class="thumbnail">
					<img src="<%=application.getContextPath() %>/<%=list.get(i).getHinhAnhSP()%>"
					...
					<div style="text-align: center;">
						...
						<p>
							<b>Giá: <%=replace(d.format(list.get(i).getGiaSP()))%></b>
						</p>
					</div>
				</div>
			</div>
					...
					<tbody>
						<tr>
							...
							<td valign="middle" style="padding: 20px 20px 20px 50px"><img
								src="<%=application.getContextPath() %>/<%=(list.get(i).getHinhAnhSP())%>" width="50px"
								height="50px"></td>
							<td valign="middle"><%=replace(d.format(list.get(i).getGiaSP()))%></td>
							<td valign="middle"><%=replace(d.format(list.get(i).getGiaDaGiam()))%></td>
							<td><a href="<%=application.getContextPath() %>/Lab4?id=<%=list.get(i).getMaDT()%>"><button
										class="btn btn-success">Xóa</button></a></td>
						</tr>
					</tbody>
					<%
						}
