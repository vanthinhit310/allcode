...
<html>
<head>
<title>Đăng kí tài khoản</title>
...
<script>
	window.onload = function(){
		var huyenTPHCM = [ "Thủ Đức", "Quận 2", "Quận 3", "Quận 4", "Quận 5", "Quận 6", "Quận 7", "Quận 8", "Quận 9",
			"Quận 10", "Quận 11"];
		var huyenHaNoi = [ "Hoàng Mai", "Đống Đa" , "Thanh Sơn" , "Ba Đình" , "Ba Vì"];
...
<body style="font-family: monospace;" id="body-dk">
	...
	<div align="center">
		<form action="<%=application.getContextPath() %>/Register" method="post">
			...
			<table style="border-spacing: 5px;" id="table-dk">
				...
				<tr>
					<td>*Mật khẩu:</td>
					<td><input  style="width: 100%" type="password" name="password" id="password">
						<p style="color: red">
							<%
				...
				<tr>
					...
					<td><input  style="width: 100%" type="password" name="repass" id="repass">
						<p style="color: red">
							<%
				...
				<tr>
					<td>*Họ và tên:</td>
					<td><input  style="width: 100%" type="text" name="hoTen" id="hoten">
						<p style="color: red">
							<%
				...
				<tr>
					<td>*Ngày sinh:</td>
					<td><select  style="width: 100%" name="ngay" id="date">
							<%
								for (int i = 1; i < 32; i++) {
							%>
							<option value="<%=i%>"><%=i%>
							...
							%>
					</select> <select  style="width: 100%" name="thang" id="month">
							<%
								for (int i = 1; i < 13; i++) {
							%>
							<option value="<%=i%>"><%=i%>
							...
							%>
					</select> <select  style="width: 100%" name="nam" id="year">
							<%
				...
				<tr>
					<td>*Số điện thoại:</td>
					<td><input  style="width: 100%" type="text" name="sdt" id="sdt">
						<p style="color: red">
							<%
				...
				<tr>
					<td>Số di động:</td>
					<td><input  style="width: 100%" type="text" name="didong" id="didong"></td>
				</tr>
				...
				<tr>
					<td><p>Quốc Gia:</p></td>
					<td><select  style="width: 100%" name="quocgia">
							<%
				...
				<div>
					<tr>
						...
						<td><select  style="width: 100%" name="quan" id="huyen">
								<%-- <%
				...
				<td>Địa chỉ:</td>
				<td><textarea  style="width: 100%" rows="4" cols="20" name="diachi" form="usrform">Nhập địa chỉ tại đây...</textarea>
				</td>
				</tr>
				</div>
			</table>
